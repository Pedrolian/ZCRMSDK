...
var attachments = function attachments()
{
    ...
    return {
        ...
        downloadFileZFS : function (input)
        {
            input.download_file = true;
            return util.promiseResponse(util.constructRequestDetails(input, "files?id="+input.id, HTTP_METHODS.GET, false));//No I18N
        },
